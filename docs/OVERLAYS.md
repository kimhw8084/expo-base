...
3. Escape/back closes safe overlays. Destructive alerts can disable backdrop dismissal and require explicit action.
...
7. Gesture-driven sheet behavior is deferred to the motion/gesture gate; the current sheet already owns geometry, dismissal, safe area, and modal semantics.
