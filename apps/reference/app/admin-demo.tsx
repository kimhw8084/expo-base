...
export default function CapabilityProtectedDemoScreen() { const router=usePrecisionRouter(); return <ScrollScreen><Card><VStack gap="lg"><Text variant="h2">Capability-protected route</Text><Text tone="secondary">This route exists only while the authenticated identity has settings.manage.</Text><Button label="Back" variant="secondary" onPress={router.back} /></VStack></Card></ScrollScreen>; }
