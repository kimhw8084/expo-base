...
const forbidden=[
  [/from\s+['"](?:victory-native|react-native-gifted-charts|react-native-chart-kit|@shopify\/react-native-skia)['"]/, 'direct chart engine; use @expo-base/visualization or add a reviewed visualization adapter'],
  [/\bchartBounds\s*\(/, 'feature-owned chart scaling; use @expo-base/visualization'],
  [/\blinePath\s*\(/, 'feature-owned chart path generation; use @expo-base/visualization'],
];
