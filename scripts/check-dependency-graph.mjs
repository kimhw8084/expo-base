...
edges('@expo-base/ui', new Set(['@expo-base/ui']), 'facade self-cycle');
edges('@expo-base/testing', new Set(['@expo-base/reference']), 'testing utilities must not depend on the reference app');
