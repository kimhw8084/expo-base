...
const forbidden=[
  [/<Modal\b/,'raw Modal; use @precision-calm/overlays'],
  [/\.measureInWindow\s*\(/,'feature-owned overlay measurement'],
  [/\.measureLayout\s*\(/,'feature-owned overlay measurement'],
  [/from\s+['"](?:@floating-ui|react-native-portal|@gorhom\/portal)/,'direct overlay positioning/portal dependency; use @precision-calm/overlays'],
];
