...
const required = [
  ...
  'golden.owner-certification.json',
  ...
  'packages/data-display/src/AnalyticsPanels.tsx',
  ...
  'packages/visualization/src/ChartAxes.tsx',
  'packages/visualization/src/ChartInspector.tsx',
  'packages/visualization/src/AreaChart.tsx',
  'packages/visualization/src/StackedBarChart.tsx',
  'packages/visualization-advanced/package.json',
  'packages/visualization-advanced/src/index.ts',
  'packages/visualization-advanced/src/AdvancedCharts.tsx',
  'packages/visualization-advanced/src/SeriesCharts.tsx',
  'packages/visualization-advanced/src/ScatterPlot.tsx',
  'packages/visualization-advanced/src/Histogram.tsx',
  'packages/visualization-advanced/src/Heatmap.tsx',
  ...
  'scripts/benchmark-visualization.mjs',
  ...
  'scripts/check-owner-certification.mjs',
  'scripts/check-dependency-graph.mjs',
  'scripts/check-ultimate-audit.mjs',
  'scripts/generate-ultimate-golden-audit.mjs',
  ...
  'packages/create-expo-base-app/package.json',
  ...
  'docs/ADR_VISUALIZATION_MODULE.md',
  'apps/reference/app/state-workbench.tsx',
  'apps/reference/workbenchFixtures.ts',
  'apps/reference/app/analytics-showcase.tsx',
  'apps/reference/app/finance-showcase.tsx',
  'apps/reference/app/monitoring-showcase.tsx',
  'apps/reference/showcaseData.ts',
  'docs/ULTIMATE_GOLDEN_AUDIT.md',
  'docs/ULTIMATE_GOLDEN_COVERAGE.md',
  'docs/ultimate-golden-capabilities.json',
  'docs/ultimate-golden-coverage.json',
  'docs/ultimate-dependency-graph.json',
  'docs/BRANDING.md',
  'docs/PORTABILITY.md',
  'scripts/release-readiness.mjs',
  'expo-base.compatibility.json',
  ...
  'packages/server-state/src/useExpoBaseQuery.ts',
  ...
  'docs/PUBLIC_API.md',
  'packages/migrate-expo-base-app/package.json',
  'packages/migrate-expo-base-app/bin/expo-base-migrate-audit.mjs',
  'scripts/test-migration-audit.mjs',
  'docs/MIGRATION.md',
  'expo-base.api.json',
  'scripts/api-snapshot.mjs',
  'packages/expo-base-doctor/package.json',
