...
export interface PrecisionBrand {
  name: string;
  shortName: string;
...
export const brandPresets: Record<BrandPresetName, PrecisionBrand> = {
  blue: {
    name: 'Precision Calm', shortName: 'P',
  ...
  violet: {
    name: 'Precision Violet', shortName: 'P',
  ...
  green: {
    name: 'Precision Green', shortName: 'P',
  ...
  orange: {
    name: 'Precision Orange', shortName: 'P',
...
export function applyBrandAccent(base: PrecisionColors, accent: BrandAccentPalette): PrecisionColors {
  return {
    ...base,
